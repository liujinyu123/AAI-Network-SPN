...
from preprocessing_haskins import Preprocessing_general_haskins
from preprocessing_mngu0 import Preprocessing_general_mngu0
from preprocessing_usc_timit import Preprocessing_general_usc
from preprocessing_mocha import Preprocessing_general_mocha
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--N_max',  type=int, default=0,
                        help='by default ')
    parser.add_argument('--corpus',  type=str, default=["MNGU0"],
